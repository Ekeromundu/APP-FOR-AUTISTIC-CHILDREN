...
public class LoginActivity2Step2 extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener, FirebaseSuccessListener, LoadUserInformation, CalendarChangeEvent {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseUtils.initFirebaseAndEmulator(); // ensures mAuth, mDatabase, mStorage are initialized
        mAuth = firebaseUtils.auth();

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        database.useEmulator("172.25.64.183", 9000); // match firebase.json // ✅ Storage emulator
        FirebaseStorage storage = FirebaseStorage.getInstance();
        storage.useEmulator("172.25.64.183", 9198); // or 9198 depending on firebase.json
